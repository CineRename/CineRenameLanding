...
| --- | --- |
| Install the application | [Installation](/en/installation) |
| Rename your first folder | [Quick Start](/en/getting-started) |
| Understand the Studio | [Studio](/en/studio) |
| Continuously monitor a folder | [Watch Folders](/en/watch-folders) |
| Ensure file integrity | [Checksums](/en/checksums) |
| Write an advanced pattern in JavaScript | [Templates](/en/templates) |
| Automate NAS / Seedbox renaming | [CLI](/en/cli) |
| Connect to Plex or Jellyfin | [Plex / Jellyfin / Emby](/en/media-servers) |
