...
2. **From the CLI** — `cinerename auto /path --to /Plex/...` (see [CLI](/en/cli)).
...
- **Reversible** — each operation is tracked individually in the [History](/en/history), therefore undoable.
