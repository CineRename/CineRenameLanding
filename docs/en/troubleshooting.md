...
1. Check that the **folder structure** matches the server conventions (see [Plex / Jellyfin / Emby](/en/media-servers)).
...
See the dedicated section in [History & Undo](/en/history#limitations-of-undo). Frequent causes:
