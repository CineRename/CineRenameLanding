...
This method is much more robust for 24/7 servers, as it silently and autonomously launches processing at regular intervals. See [Command Line (CLI)](/en/cli) for more details.
