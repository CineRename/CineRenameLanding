...
const ComparisonFilebot = () => {
  ...
  const tableData = [
    ...
    {
      label: t("comparisonFilebot.table.rows.accuracy.label"),
      cineRename: t("comparisonFilebot.table.rows.accuracy.cineRename"),
      filebot: t("comparisonFilebot.table.rows.accuracy.filebot"),
      filebotHas: true,
      highlight: false,
    },
    {
    ...
    {
      label: t("comparisonFilebot.table.rows.automation.label"),
      cineRename: t("comparisonFilebot.table.rows.automation.cineRename"),
      filebot: t("comparisonFilebot.table.rows.automation.filebot"),
      filebotHas: false,
      highlight: true,
    },
    {
      label: t("comparisonFilebot.table.rows.engine.label"),
      cineRename: t("comparisonFilebot.table.rows.engine.cineRename"),
      filebot: t("comparisonFilebot.table.rows.engine.filebot"),
      filebotHas: false,
      highlight: false,
    },
    {
      label: t("comparisonFilebot.table.rows.cli.label"),
      cineRename: t("comparisonFilebot.table.rows.cli.cineRename"),
      filebot: t("comparisonFilebot.table.rows.cli.filebot"),
      filebotHas: true,
      highlight: true,
    },
    {
